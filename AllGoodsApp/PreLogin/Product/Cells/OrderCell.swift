...
class OrderCell: UITableViewCell {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            dateLabel.leadingAnchor.constraint(equalTo: productImageView.trailingAnchor, constant: 10),
            dateLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -10),
            dateLabel.topAnchor.constraint(equalTo: customerInfoLabel.bottomAnchor, constant: 5),
            
            amountLabel.leadingAnchor.constraint(equalTo: productImageView.trailingAnchor, constant: 10),
